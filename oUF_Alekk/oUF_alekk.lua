...
local PostCreateIcon = function(self, button, icons, index, debuff)
	button.backdrop = CreateFrame("Frame", nil, button, BackdropTemplateMixin and "BackdropTemplate")
...
local UnitSpecific = {
	...
	player = function(self)	
		...
		if(tCastbar) then
			...
			self.Castbar2 = CreateFrame('StatusBar', nil, self.Castbar, BackdropTemplateMixin and "BackdropTemplate")
