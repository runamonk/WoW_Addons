...
function mnkLibs.createBorder(parent, top, bottom, left, right, color)
    ...
    -- frameborder:SetAllPoints(parent)
    ...
    -- frameborder.left:SetColorTexture(unpack(color))
    ...
    -- frameborder.right:SetColorTexture(unpack(color))
    ...
    -- frameborder.top:SetColorTexture(unpack(color))
    ...
    -- frameborder.bottom:SetColorTexture(unpack(color))
    -- parent.border = frameborder
end

function mnkLibs.updateBorderColor(parent, color)
    parent.border.left:SetColorTexture(unpack(color))
    parent.border.right:SetColorTexture(unpack(color))
    parent.border.top:SetColorTexture(unpack(color))
    parent.border.bottom:SetColorTexture(unpack(color))    
end
