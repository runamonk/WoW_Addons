...
function cache:GetItemContainer(bag, name)
    if bag == BANK_CONTAINER or bag > NUM_BAG_SLOTS then
        ...
        mnkBagsBankContainer:AddItem(self.bankContainers[name])
