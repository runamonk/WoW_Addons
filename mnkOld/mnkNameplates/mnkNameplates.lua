...
mnkNameplates.DriverFrame = CreateFrame("Frame", "mnkNameplatesFrame", UIParent); 
mnkNameplates.UnitFrame = {}
local DriverFrame = mnkNameplates.DriverFrame;
...
function DriverFrame:OnNamePlateCreated(nameplate)
	local unitFrame = CreateFrame("Button", "$parentUnitFrame", nameplate, "mnkNameplatesTemplate");
